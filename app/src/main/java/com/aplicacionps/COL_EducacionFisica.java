...
public class COL_EducacionFisica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_col_educacion_fisica);
    ...
    public void aguantoBienAsi(View view) {
        int valor = PorcentajeActual;
        String val = String.valueOf(valor);
        Intent aguantoBienAsi = new Intent(this, COL_SalidaMetroOAndando.class);
        aguantoBienAsi.putExtra("dato", val);
        startActivity(aguantoBienAsi);
    }
    ...
    public void necesitoRespirar(View view) {
        int valor = PorcentajeActual + 10;
        String val = String.valueOf(valor);
        Intent necesitoRespirar = new Intent(this, COL_SalidaMetroOAndando.class);
        necesitoRespirar.putExtra("dato", val);
        startActivity(necesitoRespirar);
    }
