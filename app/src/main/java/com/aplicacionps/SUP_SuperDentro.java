...
public class SUP_SuperDentro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sup_superdentro);
    ...
    public void guantesygel(View view){
        ...
        Intent guantesygel = new Intent (this, SUP_ColaParaPagar.class);
    ...
    public void nada(View view){
        ...
        String val= String.valueOf(valor);
        Intent nada = new Intent (this, SUP_ColaParaPagar.class);
