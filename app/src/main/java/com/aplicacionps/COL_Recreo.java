...
public class COL_Recreo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_col_recreo);
    ...
    public void noGracias(View view) {
        int valor = PorcentajeActual;
        String val = String.valueOf(valor);
        Intent noGracias = new Intent(this, COL_EducacionFisica.class);
        noGracias.putExtra("dato", val);
        startActivity(noGracias);
    }
    ...
    public void tengoHambre(View view) {
        int valor = PorcentajeActual + 10;
        String val = String.valueOf(valor);
        Intent tengoHambre = new Intent(this, COL_EducacionFisica.class);
        tengoHambre.putExtra("dato", val);
        startActivity(tengoHambre);
    }
